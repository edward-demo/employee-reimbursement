                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <p className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Medicine</p>
                      </div>
                    ...
                    <div className="border-t pt-4">
                      {/* Optical Balance */}
                      <div className="flex items-center justify-between mb-2">
                        <p className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Optical</p>
                      </div>
          ...
          <TabsContent value="requests" className="space-y-6 data-[state=active]:animate-in data-[state=active]:fade-in data-[state=active]:slide-in-from-right-8 data-[state=active]:duration-200">
            ...
            <div className="space-y-4">
              {reimbursementRequests
                .filter(request => filterYear === "all" || new Date(request.submittedDate).getFullYear().toString() === filterYear)
                .map((request) => (
                <Card key={request.id} className="">
                  <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        <label className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Total Amount</label>
                        <p className="font-semibold">₱{request.totalPrice}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Submitted Date</label>
