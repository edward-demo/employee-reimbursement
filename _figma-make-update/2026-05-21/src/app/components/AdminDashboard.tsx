                ...
                <Card key={request.id} className="">
                  <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                      <div>
                        <label className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>
                      ...
                      <div>
                        <label className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Total Receipts</label>
                        <p>{request.receipts.length} receipt{request.receipts.length !== 1 ? 's' : ''}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Amount</label>
                        <p className="font-semibold text-lg">₱{request.totalPrice.toFixed(2)}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Submitted</label>
                    ...
                    {request.remarks && (
                      <div className="bg-muted/20 p-3 rounded-md mb-4">
                        <label className="text-sm font-medium" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Remarks</label>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Name</Label>
                          ...
                          <div>
                            <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Submitted Date</Label>
                            <p className="font-medium">{selectedRequest.submittedDate}</p>
                          </div>
                          {selectedRequest.lineManagerName && (
                            <div className="col-span-2">
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Approved By (Line Manager)</Label>
                    ...
                    {(selectedRequest.status === 'approved' || selectedRequest.status === 'denied') && (
                      <Card className={selectedRequest.status === 'approved' ? 'border-green-200 bg-green-50/50' : 'border-red-200 bg-red-50/50'}>
                        ...
                        <CardContent>
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>HR Full Name</Label>
                              <p className="font-medium">{selectedRequest.hrFullName}</p>
                            </div>
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>
                            ...
                            {selectedRequest.status === 'denied' && selectedRequest.denialReason && (
                              <div className="col-span-2">
                                <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Denial Reason</Label>
                    ...
                    <Card className="border-2">
                      <CardContent className="p-8 space-y-6">
                        ...
                        <div className="space-y-3">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Requestor ID#</Label>
                              <p className="font-medium">{selectedRequest.employeeId}</p>
                            </div>
                            <div>
                          ...
                          <div>
                            <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Subject</Label>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Date of Request</Label>
                              <p className="font-medium">{selectedRequest.submittedDate}</p>
                            </div>
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Invoice Number</Label>
                        ...
                        {/* Item List */}
                        <div>
                          <Label className="text-sm mb-3 block" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Item List</Label>
                        ...
                        <div className="space-y-3">
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Requestor</Label>
                              <p className="font-medium">{selectedRequest.employeeName}</p>
                              <p className="text-xs" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>{selectedRequest.submittedDate}</p>
                            </div>
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>HR Approval</Label>
                              <p className="font-medium">{selectedRequest.hrFullName}</p>
                            </div>
                            <div>
                              <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Line Manager</Label>
                              <p className="font-medium">{selectedRequest.lineManagerName}</p>
                            </div>
                          </div>
                        </div>
