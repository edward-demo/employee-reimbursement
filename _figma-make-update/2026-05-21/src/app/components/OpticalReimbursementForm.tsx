        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card className="border-2 border-primary/10">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="flex items-center opacity-72" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>
                    ...
                    {receipts.map((receipt, index) => (
                      <Card key={receipt.id} className="border-2 border-green-200 bg-green-50/50">
                        <CardContent className="p-4 space-y-3">
                          ...
                          {/* Invoice Number */}
                          <div className="space-y-2">
                            <Label className="text-sm opacity-72" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Invoice/Receipt Number *</Label>
          ...
          <Card className="border-2 border-primary/10">
            ...
            <CardContent className="space-y-6">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="md:col-span-2 space-y-2">
                          <Label className="opacity-72" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Item Name *</Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label className="opacity-72" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Quantity *</Label>
                          <Input
                            placeholder="e.g., 30"
                            type="number"
                            step="0.01"
                        ...
                        <div className="space-y-2">
                          <Label className="opacity-72" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Unit Price (₱) *</Label>
                          <Input
                            placeholder="0.00"
                            type="number"
                            step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="notes" className="opacity-72" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Additional Notes (Optional)</Label>
                <Textarea
                  id="notes"
          ...
          <Card className="border-2 border-secondary/20 bg-secondary/5">
            ...
            <CardContent className="space-y-4">
              ...
              {receipts.some(r => r.isPWD) && (
                <>
                  <div className="space-y-2">
                    <Label className="text-sm text-muted-foreground" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>Deductions:</Label>
                    <div className="bg-white/50 rounded-lg p-3 space-y-2">
                      {receipts.map((receipt, index) => (
