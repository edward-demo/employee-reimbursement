        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card className="border-2 border-primary/10">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="flex items-center" style={{ color: 'rgba(0, 0, 0, 0.64)' }}>
                    ...
                    {receipts.map((receipt, index) => (
                      <Card key={receipt.id} className="border-2 border-green-200 bg-green-50/50">
                        <CardContent className="p-4 space-y-3">
                          ...
                          {/* Invoice Number */}
                          <div className="space-y-2">
                            <Label className="text-sm" style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Invoice/Receipt Number *</Label>
          ...
          <Card className="border-2 border-primary/10">
            ...
            <CardContent className="space-y-6">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="md:col-span-2 space-y-2">
                          <Label style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Medicine Name *</Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Quantity *</Label>
                          <Input
                            placeholder="e.g., 30"
                            type="number"
                            step="0.01"
                        ...
                        <div className="space-y-2">
                          <Label style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Unit Price (₱) *</Label>
                          <Input
                            placeholder="0.00"
                            type="number"
                            step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="notes" style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Additional Notes (Optional)</Label>
                <Textarea
                  id="notes"
          ...
          <Card className="border-2 border-secondary/20 bg-secondary/5">
            ...
            <CardContent className="space-y-4">
              ...
              {/* Medicine Summary */}
              <div className="space-y-2">
                <Label className="text-sm text-muted-foreground" style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Medicines Breakdown ({medicines.length} items):</Label>
              ...
              {receipts.some(r => r.isPWD) && (
                <>
                  <div className="flex justify-between items-center text-sm">
                    <span style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Total VAT Deduction:</span>
                    <span className="font-medium">-₱{receipts.reduce((sum, r) => sum + (parseFloat(r.vatDeduction) || 0), 0).toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span style={{ color: 'rgba(0, 0, 0, 0.64)' }}>Total PWD Discount:</span>
