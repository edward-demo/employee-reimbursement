...
export function ComponentLibrary({ onBack }: ComponentLibraryProps) {
  ...
  const colorPalette = [
    { name: 'Primary', value: '#0B8BCB', description: 'Main brand color for primary actions' },
    { name: 'Secondary', value: '#62C3F3', description: 'Accent color for highlights and secondary actions' },
    { name: 'Muted', value: '#B4D3E2', description: 'Subtle accent for backgrounds and borders' },
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 bg-white">
            <TabsTrigger value="overview" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-primary hover:text-primary-foreground">
              Overview
            </TabsTrigger>
            <TabsTrigger value="colors" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-primary hover:text-primary-foreground">
              Colors
            </TabsTrigger>
            <TabsTrigger value="components" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-primary hover:text-primary-foreground">
              Components
            </TabsTrigger>
            <TabsTrigger value="examples" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-primary hover:text-primary-foreground">
              Examples
            </TabsTrigger>
          </TabsList>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <h4 className="font-semibold text-primary mb-2">Primary (#0B8BCB)</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-secondary mb-2">Secondary (#62C3F3)</h4>
                    <ul className="text-sm space-y-1 text-muted-foreground">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2" style={{ color: '#B4D3E2' }}>Muted (#B4D3E2)</h4>
                    <ul className="text-sm space-y-1 text-muted-foreground">
