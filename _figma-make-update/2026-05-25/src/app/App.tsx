...
export default function App() {
  ...
  const handleSubmitRequest = () => {
    toast.success("Your request has been sent for review. You'll be notified once it's processed.", {
            ...
            <div className="text-center space-y-4">
              ...
              <div className="flex items-center justify-center space-x-4 pt-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm">#0B8BCB Primary</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 rounded-full bg-secondary"></div>
                  <span className="text-sm">#62C3F3 Secondary</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 rounded-full bg-muted"></div>
                  <span className="text-sm">#B4D3E2 Accent</span>
                </div>
              </div>
            </div>
