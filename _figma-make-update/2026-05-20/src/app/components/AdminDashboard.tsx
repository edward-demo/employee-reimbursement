                  ...
                  <div className="h-[350px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={departmentStatsCombined}>
                        <CartesianGrid key="grid-combined" strokeDasharray="3 3" stroke="#E1B3CE" opacity={0.3} />
                        <XAxis
                          key="xaxis-combined"
                          dataKey="department"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          {selectedRequest.lineManagerName && (
                            <div className="col-span-2">
                              <Label className="text-sm text-muted-foreground">Approved By (Line Manager)</Label>
                    ...
                    <Card className="border-2">
                      <CardContent className="p-8 space-y-6">
                        ...
                        <div className="space-y-3">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label className="text-sm text-muted-foreground">Requestor ID#</Label>
                              <p className="font-medium">{selectedRequest.employeeId}</p>
                            </div>
                            <div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label className="text-sm text-muted-foreground">Date of Request</Label>
                              <p className="font-medium">{selectedRequest.submittedDate}</p>
                            </div>
                            <div>
                        ...
                        {/* Item List */}
                        <div>
                          <Label className="text-sm text-muted-foreground mb-3 block">Item List</Label>
                        ...
                        <div className="space-y-3">
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              ...
                              <p className="font-medium">{selectedRequest.employeeName}</p>
                              <p className="text-xs text-muted-foreground">{selectedRequest.submittedDate}</p>
                            </div>
                            <div>
                              <Label className="text-sm text-muted-foreground">HR Approval</Label>
                              <p className="font-medium">{selectedRequest.hrFullName}</p>
                            </div>
                            <div>
