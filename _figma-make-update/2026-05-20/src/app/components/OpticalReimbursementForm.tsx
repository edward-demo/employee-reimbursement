...
export function OpticalReimbursementForm({ onBack, onSubmit }: OpticalReimbursementFormProps) {
  ...
  const getTotalAmount = () => {
    return opticalItems.reduce((total, item) => total + item.subtotal, 0);
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="mt-4 p-3 bg-secondary/10 rounded-lg">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-semibold text-secondary">₱{opticalItem.subtotal.toFixed(2)}</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <Card className="border-2 border-secondary/20 bg-secondary/5">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-sm text-muted-foreground">Optical Items Breakdown ({opticalItems.length} items):</Label>
